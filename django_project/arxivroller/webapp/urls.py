...
urlpatterns = [
    ...
    path('accounts/setting/', views.user_setting, name='user_setting'),
    ...
    path('api/user_preference/', serializers.user_preference, name='user_preference_api'),
    path('api/user_paper/', serializers.user_paper, name='user_paper_api'),
    path('api/user_tags/', serializers.user_tags, name='user_tags_api'),
    path('api/user_profile/', serializers.user_profile, name='user_profile_api'),
    path('api/rename_tag/', serializers.rename_tag, name='rename_tag_api'),
]